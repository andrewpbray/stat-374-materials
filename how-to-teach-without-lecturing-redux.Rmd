...
knitr::include_graphics("figs/bridge-expansion-joint.jpeg")
```
]
...
3. Individual poll: 1 min

--

4. Discuss with someone who disagrees: 4 min

--

5. Individual Re-poll: 30 sec
...
knitr::include_graphics("figs/metal-plate.png")
```
]

.task[
Enter your response at `pollev.com/stat20`.
]
```{r echo = FALSE}
...
<center>
<iframe src="https://embed.polleverywhere.com/multiple_choice_polls/stdIN98JSrC9NAmzIpbH4?controls=none&short_poll=true" width="800px" height="600px"></iframe>
</center>
...
<center>
<iframe src="https://embed.polleverywhere.com/multiple_choice_polls/51zfeCU3TKBPLTUssLU6h?controls=none&short_poll=true" width="800px" height="600px"></iframe>
</center>
...
knitr::include_graphics("figs/lecture.gif")
```
...
I am going to present results from three studies.

While I present, write down _three_ critiques of this line of evidence, or three questions that you have about its efficacy.
...
```{r echo = FALSE, out.width = "100%"}
knitr::include_graphics("figs/pnas-active-learning.png")
```
...
```{r echo = FALSE, out.width = "70%"}
knitr::include_graphics("figs/pnas-active-learning-2.png")
```
...
```{r echo = FALSE, out.width = "100%"}
knitr::include_graphics("figs/active-feelings.png")
```
...
```{r echo = FALSE, out.width = "70%"}
knitr::include_graphics("figs/active-feelings-2.png")
```
...
```{r echo = FALSE, out.width = "100%"}
knitr::include_graphics("figs/jse-flipped.png")
```
...
```{r echo = FALSE, out.width = "80%"}
knitr::include_graphics("figs/jse-flipped-2.png")
```
...
.task[
Discuss your critiques with a neighbor. I will ask for three pairs to share their answers.
]
